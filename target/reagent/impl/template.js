...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__6830__auto__,writer__6831__auto__,opt__6832__auto__){
return cljs.core._write(writer__6831__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__12602 = o;
(G__12602[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
if(cljs.core.truth_((function (){var and__6212__auto__ = cljs.core.some_QMARK_(reagent.impl.template.find_dom_node);
if(and__6212__auto__){
var and__6212__auto____$1 = cljs.core.some_QMARK_(jsprops);
if(and__6212__auto____$1){
var and__6212__auto____$2 = (jsprops["hasOwnProperty"])("onChange");
if(cljs.core.truth_(and__6212__auto____$2)){
...
var G__12610 = jsprops;
(G__12610["defaultValue"] = value);

(G__12610["onChange"] = ((function (G__12610,v,value,on_change){
return (function (p1__12608_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__12608_SHARP_);
});})(G__12610,v,value,on_change))
);
...
var vec__12617 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12617,(0),null);
...
var jsprops = {"argv": v};
var temp__4661__auto___12622 = reagent.impl.template.key_from_vec(v);
if((temp__4661__auto___12622 == null)){
} else {
var key_12623 = temp__4661__auto___12622;
(jsprops["key"] = key_12623);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__12625 = (new reagent.impl.template.NativeWrapper());
(G__12625["name"] = c);
...
var G__12627 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__12627) : reagent.impl.template.as_element.call(null,G__12627));
} else {
...
var len__7299__auto___12633 = arguments.length;
var i__7300__auto___12634 = (0);
while(true){
if((i__7300__auto___12634 < len__7299__auto___12633)){
args__7306__auto__.push((arguments[i__7300__auto___12634]));

var G__12635 = (i__7300__auto___12634 + (1));
i__7300__auto___12634 = G__12635;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__7307__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq12631){
var G__12632 = cljs.core.first(seq12631);
var seq12631__$1 = cljs.core.next(seq12631);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__12632,seq12631__$1);
});
...
break;
default:
var G__12639 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__12639;
continue;
...
var n__7139__auto___12642 = a.length;
var i_12643 = (0);
while(true){
if((i_12643 < n__7139__auto___12642)){
(a[i_12643] = reagent.impl.template.as_element((a[i_12643])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__7139__auto___12645 = a.length;
var i_12646 = (0);
while(true){
if((i_12646 < n__7139__auto___12645)){
var val_12647 = (a[i_12646]);
if((cljs.core.vector_QMARK_(val_12647)) && ((reagent.impl.template.key_from_vec(val_12647) == null))){
(o["no-key"] = true);
} else {
}

(a[i_12646] = reagent.impl.template.as_element(val_12647));
...
var ctx = {};
var vec__12652 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12652,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12652,(1),null);
...
var G__12656 = (cljs.core.count(argv) - first_child);
switch (G__12656) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__12656){
